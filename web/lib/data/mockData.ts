...
export const MOCK_EXPENSES: ExpenseRecord[] = [
  ...
  { id: 'EX2026072603', asset_id: REAL_ASSET_IDS.MAZDA2_2026, date: '2026-07-26', category: 'Running', subcategory: 'Car Wash', amount: 50000, currency: 'VND', vendor: 'Anh Chung Lương', odometer_km: 2163, description: 'Rửa xe nhà anh Chung Lương' },
...
export const MOCK_ODOMETER_LOGS: OdometerLogRecord[] = [
  { id: 'ODO2026040901', asset_id: 'f1', date: '2026-04-09', odometer_km: 12, note: 'Nhận xe' },
  { id: 'ODO2026041101', asset_id: 'f1', date: '2026-04-11', odometer_km: 24, note: 'Bắt đầu nâng cấp' },
  { id: 'ODO2026041201', asset_id: 'f1', date: '2026-04-12', odometer_km: 108, note: 'Về 2 quê' },
  { id: 'ODO2026041401', asset_id: 'f1', date: '2026-04-14', odometer_km: 195, note: 'Về nhà bà ngoại lấy đồ' },
  { id: 'ODO2026041701', asset_id: 'f1', date: '2026-04-17', odometer_km: 218, note: 'Mưa to trời có dị tượng' },
  { id: 'ODO2026041901', asset_id: 'f1', date: '2026-04-19', odometer_km: 235, note: 'Ăn cưới Giang Thắng' },
  { id: 'ODO2026042301', asset_id: 'f1', date: '2026-04-23', odometer_km: 251, note: '' },
  { id: 'ODO2026042501', asset_id: 'f1', date: '2026-04-25', odometer_km: 281, note: '' },
  { id: 'ODO2026042601', asset_id: 'f1', date: '2026-04-26', odometer_km: 386, note: '' },
  { id: 'ODO2026043001', asset_id: 'f1', date: '2026-04-30', odometer_km: 409, note: '' },
  { id: 'ODO2026050101', asset_id: 'f1', date: '2026-05-01', odometer_km: 437, note: '' },
  { id: 'ODO2026050201', asset_id: 'f1', date: '2026-05-02', odometer_km: 479, note: 'Xuống gì Nga chơi' },
  { id: 'ODO2026050301', asset_id: 'f1', date: '2026-05-03', odometer_km: 525, note: '' },
  { id: 'ODO2026050401', asset_id: 'f1', date: '2026-05-04', odometer_km: 568, note: '' },
  { id: 'ODO2026050701', asset_id: 'f1', date: '2026-05-07', odometer_km: 583, note: '' },
  { id: 'ODO2026050901', asset_id: 'f1', date: '2026-05-09', odometer_km: 601, note: '' },
  { id: 'ODO2026051001', asset_id: 'f1', date: '2026-05-10', odometer_km: 653, note: 'Xước sau xe va vào cửa bác Nhật' },
  { id: 'ODO2026051101', asset_id: 'f1', date: '2026-05-11', odometer_km: 683, note: '' },
  { id: 'ODO2026051201', asset_id: 'f1', date: '2026-05-12', odometer_km: 686, note: '' },
  { id: 'ODO2026051301', asset_id: 'f1', date: '2026-05-13', odometer_km: 720, note: '' },
  { id: 'ODO2026051801', asset_id: 'f1', date: '2026-05-18', odometer_km: 730, note: '' },
  { id: 'ODO2026051901', asset_id: 'f1', date: '2026-05-19', odometer_km: 732, note: '' },
  { id: 'ODO2026052001', asset_id: 'f1', date: '2026-05-20', odometer_km: 771, note: '' },
  { id: 'ODO2026052201', asset_id: 'f1', date: '2026-05-22', odometer_km: 784, note: '' },
  { id: 'ODO2026052401', asset_id: 'f1', date: '2026-05-24', odometer_km: 804, note: '' },
  { id: 'ODO2026052701', asset_id: 'f1', date: '2026-05-27', odometer_km: 824, note: '' },
  { id: 'ODO2026052801', asset_id: 'f1', date: '2026-05-28', odometer_km: 853, note: '' },
  { id: 'ODO2026052901', asset_id: 'f1', date: '2026-05-29', odometer_km: 913, note: '' },
  { id: 'ODO2026060301', asset_id: 'f1', date: '2026-06-03', odometer_km: 989, note: '' },
  { id: 'ODO2026060401', asset_id: 'f1', date: '2026-06-04', odometer_km: 1014, note: '' },
  { id: 'ODO2026060601', asset_id: 'f1', date: '2026-06-06', odometer_km: 1035, note: '' },
  { id: 'ODO2026060701', asset_id: 'f1', date: '2026-06-07', odometer_km: 1044, note: '' },
  { id: 'ODO2026061301', asset_id: 'f1', date: '2026-06-13', odometer_km: 1109, note: '' },
  { id: 'ODO2026061401', asset_id: 'f1', date: '2026-06-14', odometer_km: 1167, note: '' },
  { id: 'ODO2026061801', asset_id: 'f1', date: '2026-06-18', odometer_km: 1176, note: 'Xem nhà thầy tiếng Anh ở Bắc Đầm Vạc' },
  { id: 'ODO2026062101', asset_id: 'f1', date: '2026-06-21', odometer_km: 1270, note: '' },
  { id: 'ODO2026062201', asset_id: 'f1', date: '2026-06-22', odometer_km: 1286, note: '' },
  { id: 'ODO2026062401', asset_id: 'f1', date: '2026-06-24', odometer_km: 1312, note: '' },
  { id: 'ODO2026062501', asset_id: 'f1', date: '2026-06-25', odometer_km: 1332, note: '' },
  { id: 'ODO2026063001', asset_id: 'f1', date: '2026-06-30', odometer_km: 1500, note: '' },
  { id: 'ODO2026070101', asset_id: 'f1', date: '2026-07-01', odometer_km: 1531, note: '' },
  { id: 'ODO2026070201', asset_id: 'f1', date: '2026-07-02', odometer_km: 1614, note: '' },
  { id: 'ODO2026070301', asset_id: 'f1', date: '2026-07-03', odometer_km: 1671, note: '' },
  { id: 'ODO2026070401', asset_id: 'f1', date: '2026-07-04', odometer_km: 1686, note: '' },
  { id: 'ODO2026070501', asset_id: 'f1', date: '2026-07-05', odometer_km: 1722, note: '' },
  { id: 'ODO2026070701', asset_id: 'f1', date: '2026-07-07', odometer_km: 1752, note: '' },
  { id: 'ODO2026070801', asset_id: 'f1', date: '2026-07-08', odometer_km: 1765, note: '' },
  { id: 'ODO2026071001', asset_id: 'f1', date: '2026-07-10', odometer_km: 1796, note: '' },
  { id: 'ODO2026071401', asset_id: 'f1', date: '2026-07-14', odometer_km: 1880, note: '' },
  { id: 'ODO2026071501', asset_id: 'f1', date: '2026-07-15', odometer_km: 1920, note: 'Bảo dưỡng lần đầu Thaco' },
  { id: 'ODO2026071601', asset_id: 'f1', date: '2026-07-16', odometer_km: 1944, note: '' },
  { id: 'ODO2026071701', asset_id: 'f1', date: '2026-07-17', odometer_km: 1975, note: '' },
  { id: 'ODO2026071801', asset_id: 'f1', date: '2026-07-18', odometer_km: 1997, note: '' },
  { id: 'ODO2026072301', asset_id: 'f1', date: '2026-07-23', odometer_km: 2109, note: '' },
  { id: 'ODO2026072401', asset_id: 'f1', date: '2026-07-24', odometer_km: 2132, note: '' },
  { id: 'ODO2026072501', asset_id: 'f1', date: '2026-07-25', odometer_km: 2151, note: '' },
  { id: 'ODO2026072601', asset_id: 'f1', date: '2026-07-26', odometer_km: 2163, note: '' },
  { id: 'ODO2026073101', asset_id: 'f1', date: '2026-07-31', odometer_km: 2265, note: '' },
  { id: 'ODO2026080101', asset_id: 'f1', date: '2026-08-01', odometer_km: 2292, note: '' },
  { id: 'ODO2026080401', asset_id: 'f1', date: '2026-08-04', odometer_km: 2351, note: '' },
  { id: 'ODO2026080901', asset_id: 'f1', date: '2026-08-09', odometer_km: 2436, note: '' },
  { id: 'ODO2026081401', asset_id: 'f1', date: '2026-08-14', odometer_km: 2470, note: '' },
  { id: 'ODO2026081501', asset_id: 'f1', date: '2026-08-15', odometer_km: 2506, note: '' },
  { id: 'ODO2026082001', asset_id: 'f1', date: '2026-08-20', odometer_km: 2602, note: '' },
  { id: 'ODO2026082301', asset_id: 'f1', date: '2026-08-23', odometer_km: 2651, note: '' },
];
