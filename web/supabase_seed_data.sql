...
BEGIN
  ...
  (v_mazda_id, '2026-04-19', 'CAR_WASH', 2200000, 'VND', NULL, 235, 'Máy rửa xe gia đình'),
  (v_mazda_id, '2026-04-21', 'UPGRADE', 389000, 'VND', 'Toyota', 235, 'Bơm lốp Toyota'),
  (v_mazda_id, '2026-07-26', 'CAR_WASH', 250000, 'VND', NULL, 2163, 'Khử mùi trong xe vị cafe'),
  ...
  (v_mazda_id, '2026-04-28', 'LOAN_PAYMENT', 6020408, 'VND', 'TPBank', NULL, 'Thanh toán gốc kỳ 1 (04/2026)'),
  (v_mazda_id, '2026-04-28', 'LOAN_INTEREST', 1357808, 'VND', 'TPBank', NULL, 'Thanh toán lãi kỳ 1 (04/2026)'),
  (v_mazda_id, '2026-05-27', 'LOAN_PAYMENT', 6020408, 'VND', 'TPBank', NULL, 'Thanh toán gốc kỳ 2 (05/2026)'),
  (v_mazda_id, '2026-05-27', 'LOAN_INTEREST', 1773464, 'VND', 'TPBank', NULL, 'Thanh toán lãi kỳ 2 (05/2026)'),
  (v_mazda_id, '2026-06-26', 'LOAN_PAYMENT', 6020408, 'VND', 'TPBank', NULL, 'Thanh toán gốc kỳ 3 (06/2026)'),
  (v_mazda_id, '2026-06-26', 'LOAN_INTEREST', 1922572, 'VND', 'TPBank', NULL, 'Thanh toán lãi kỳ 3 (06/2026)'),
  (v_mazda_id, '2026-07-26', 'LOAN_PAYMENT', 6020408, 'VND', 'TPBank', NULL, 'Thanh toán gốc kỳ 4 (07/2026)'),
  (v_mazda_id, '2026-07-26', 'LOAN_INTEREST', 1881666, 'VND', 'TPBank', NULL, 'Thanh toán lãi kỳ 4 (07/2026)'),
