...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "REV", "\"136\"") // chống nhập sai giá: live preview tổng tiền + chặn giá <10k đ/L (thiếu ×1000)
    }
...
dependencies {
    ...
    // CameraX for ADAS Vision & Computer Vision HUD
    ...
    // TensorFlow Lite for AI ADAS Real-Time Vehicle & Obstacle Detection
