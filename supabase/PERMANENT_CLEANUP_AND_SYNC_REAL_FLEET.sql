...
BEGIN
  ...
  (v_carnival_id, target_user_id, 'Honda CR-V e:HEV RS (Dự kiến)', 'CAR', 'SUV 5 chỗ Hybrid', 'HONDA', 'CR-V', 2026, '2.0L e:HEV RS', 'Trắng Ngọc Trai', 'CRV-HYBRID', NULL, '2.0L i-VTEC + 2 Motor Hybrid (204Hp, 335Nm)', 'HYBRID', 53.0, '2027-01-01', 1259000000, 1259000000, 0, 0, 0, 'VIRTUAL', 'INACTIVE', 'https://images.unsplash.com/photo-1606016159991-dfe4f2746ad5?q=80&w=1200&auto=format&fit=crop', 'Mục tiêu nâng cấp xe gầm cao thể thao Hybrid cao cấp nhất cho gia đình (Honda CR-V e:HEV RS). Động cơ 2.0L Hybrid 204Hp, gói an toàn Honda SENSING, siêu tiết kiệm nhiên liệu (3.4L/100km).', 'Showroom Honda Ô tô', '1800 8001', '1800 8001');
